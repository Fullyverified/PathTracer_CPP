...
bool AABCubeBounds::objectCulling(const Ray &ray) const override {
...
bool AABCubeBounds::intersectionCheck(const Ray &ray) const override {
...
std::pair<Vector3, Vector3> AABCubeBounds::getBounds(const Ray &ray) const {
